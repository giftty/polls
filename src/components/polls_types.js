...
var multichioceObj = []
var postObj = {'id':'', 'image':'','data':multichioceObj} 
...
function Question({questionString='',options=[],answer=''}){
 ...
 var obj= {'questionString':'', 'option':[],'answer':''}
 var objIndex = 0
...
export function PreviewComp({questionstyle,questionString,option= [],answer= "",participates=0,callbackfunc}){
   ...
   <div className="preview ">
     ...
     <br/>
      ...
      <br/>
               ...
               {
                 option.map((opt,i)=>
                 <div key={i} className="card shadow-sm mx-4 my-2" style={selectedOption==i?{borderRadius:'15px',minHeight:'40px',backgroundColor:"#a9e3fc"}:{borderRadius:'15px',minHeight:'40px',backgroundColor:"white"}} >
                ...
                setOptionCounts(i)}}>
                 ...
                 <div className="pl-3" >{opt['optionString']}</div>
                </div>
              </div>
                )
                  ...
                  console.log(result)
                    ...
                    if(typeof result['data'] != undefined){
                      ...
                      div.classList = 'alert alert-danger small'
                       var textnode = document.createTextNode("An error occurred")
                       div.appendChild(textnode)
                       document.getElementById('messageBox').prepend(div)
                       document.getElementById('openModal').click()
                    }
